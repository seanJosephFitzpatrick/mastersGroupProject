...
public class FailureClassWSTest {
	...
	public static Archive<?> createTestArchive() {
		return ShrinkWrap.create(JavaArchive.class, "TestFailureClassWS.jar")
				.addClasses(FailureClassDAO.class, FailureClass.class, JaxRsActivator.class, FailureClassWS.class,
						UtilsDAO.class, EventCauseDAO.class, BaseData.class, MccMnc.class, MccMncPK.class,
						EventCause.class, EventCausePK.class, Ue.class)
