...
public class EventCauseWSTest {
	...
	public static Archive<?> createTestArchive() {
		return ShrinkWrap.create(JavaArchive.class, "TestEventCauseWS.jar")
				.addClasses(EventCauseDAO.class, EventCause.class, EventCausePK.class, JaxRsActivator.class,
						EventCauseWS.class, UtilsDAO.class, FailureClassDAO.class, BaseData.class, MccMnc.class,
						MccMncPK.class, EventCause.class, EventCausePK.class, FailureClass.class, Ue.class)
